...
const babelConfig = Object.assign(
  {},
  require('../../shared/babelConfig.json'),
  {
    cacheDirectory: true,
  },
);
...
const bundleNamesFile = path.join(
  __dirname,
  '..',
  '..',
  '.webpack_bundle_names.json',
);
...
const monorepoRoot = process.env.ROOT_DIR || path.resolve(__dirname, '../../');
      ...
      rules: [
        {
          ...
          include: [
            ...
            path.resolve(monorepoRoot, 'packages', 'languages'),
            path.resolve(monorepoRoot, 'packages', 'sentry-browser'),
            path.resolve(monorepoRoot, 'packages', 'tracking'),
          ],
