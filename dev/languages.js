...
//     basic: {
//         cmMode: 'basic',
//         example: `1000 REM Snake and Dots
...
// 2320 IF C = "W" THEN LET G[P + Q *25] = 2
// 2330 IF C = "S" THEN LET G[P + Q *25] = 1
// 2340 IF C = "A" THEN LET G[P + Q *25] = 3
// 2350 IF C = "D" THEN LET G[P + Q *25] = 4
...
//         window.languages[lang] = knownLanguages[lang] || { example: 'add some code', cmMode: ''}
//     })
//   })